        ...
        <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
            <div class="flex justify-center mb-5"> {{-- Wrapper untuk memusatkan card judul --}}
                <div class="bg-white shadow-md rounded-4xl px-20 py-2.5 w-fit"> {{-- Card judul dengan w-fit --}}
                    <h1 class="text-3xl font-bold tracking-tight text-gray-900 text-center">Akun guru</h1>
                </div>
            </div>
                            ...
                            <form class="p-4 md:p-5">
                                <div class="grid gap-4 mb-4 grid-cols-1">
                                    ...
                                    <div class="col-span-1">
                                        ...
                                        <input type="text" name="nisn_Guru" id="nisn_Guru"
                                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5"
                                            placeholder="Masukkan NISN Guru" required="">
                                    </div>
                                    <div class="col-span-1">

...
<body class="min-h-screen flex items-center justify-center bg-[#050A24]  font-sans text-gray-900 relative">
  ...
  <div class="bg-white 50 backdrop-blur-md rounded-2xl shadow-xl p-8 w-full max-w-md">
    ...
    <p class="text-center text-sm mt-4">Don't Have An Account? <a href="signup-admin" class="text-blue-600 hover:underline">Sign
      Up</a></p>
    <p class="text-center text-sm mt-1">Go back to <a href="login-siswa" class="text-blue-600 hover:underline">Student</a> or <a href="login-guru" class="text-blue-600 hover:underline">Teacher</a> login</p>
  </div>
  <script>

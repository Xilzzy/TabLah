...
<head>
  ...
  <title>Create Student Account - TABLAH</title>
...
<body class="min-h-screen flex">
  ...
  <div class="flex flex-1 flex-col justify-center p-8 bg-white-50">
    <div class="max-w-md w-full mx-auto">
      <h2 class="text-3xl font-semibold mb-6">Create an student account</h2>
      <form class="space-y-4">
        <div>
          <label class="block text-gray-700">NIK</label>
          <input type="text" placeholder="Enter your NIK" class="w-full mt-1 px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" />
        </div>
        <div>
      ...
      <p class="text-center text-gray-600 mt-4">Already Have An Account? <a href="login-siswa" class="text-blue-600">Log In</a></p>
    </div>
  </div>
   <!-- Script Toggle Mata -->
<script>

...
<head>
  ...
  <title>Create Teacher Account - TABLAH</title>
...
<body class="min-h-screen flex">
  ...
  <div class="flex flex-1 flex-col justify-center p-8 bg-white-50"> 
    <div class="max-w-md w-full mx-auto">
      <h2 class="text-3xl font-semibold mb-6">Create a teacher account</h2>
      <form class="space-y-4">
        <div>
          <label class="block text-gray-700">NIP</label>
          <input type="text" placeholder="Enter your NIP" class="w-full mt-1 px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" />
        </div>
        <div>
      ...
      <p class="text-center text-gray-600 mt-4">Already Have An Account? <a href="login-guru" class="text-blue-600">Log In</a></p>
    </div>
  </div>
